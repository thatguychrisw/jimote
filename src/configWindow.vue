<template>
    <v-app class="config-window">
        <v-snackbar :timeout="4000" :top="true" v-model="showJiraError">
            Unable to communicate with JIRA.
            <v-btn flat color="white" @click.native="showJiraError = false">Close</v-btn>
        </v-snackbar>
                            ...
                            <div class="form">
                                <v-form v-model="valid" ref="projectForm" lazy-validation>
                                    ...
                                    <div class="actions">
                                        ...
                                        <v-btn v-if="jiraClient !== null" flat
                                               @click.native="setStep('jira')">
                                            Back
                                        </v-btn>
                                    </div>
                                </v-form>
                    ...
                    <v-layout row wrap>
                        <v-flex xs12>
                            <div class="info">
                                ...
                                <h3>Use ⌘+⌥+J to start using Jimote!</h3>
                            </div>
                        </v-flex>
                    </v-layout>
                </v-stepper-content>
        ...
        methods: {
            processJiraStep() {
                if (this.$refs.form.validate()) {
                    ...
                    console.log('Connecting to Jira using the following configuration', {host, username, password});
